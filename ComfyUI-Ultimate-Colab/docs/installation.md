...
```
https://colab.research.google.com/github/your-username/ComfyUI-Ultimate-Colab/blob/main/ComfyUI_Ultimate_Colab.ipynb
```
...
```bash
# Clone the project
git clone https://github.com/your-username/ComfyUI-Ultimate-Colab.git
